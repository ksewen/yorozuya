...
/**
 * @author ksewen
 * @date 05.10.2023 17:49
 */
@Aspect
@Slf4j
public class RecordByDefaultAroundLogger extends BasicAroundLogger {

  public RecordByDefaultAroundLogger(Environment environment, JsonHelpers jsonHelpers) {
  ...
  @Pointcut(
      "(@within(org.springframework.web.bind.annotation.RestController) "
          ...
          + "|| @annotation(com.github.ksewen.yorozuya.starter.annotation.logger.LoggerTrace)) "
          + "&& !@annotation(com.github.ksewen.yorozuya.starter.annotation.logger.LoggerNotTrace) "
