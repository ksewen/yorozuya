...
class RecordByDefaultAroundLoggerTest {
  ...
  @Test
  void testAspect() {
    assertNotEquals(this.mockService.getClass(), MockService.class);
    assertTrue(AopUtils.isAopProxy(this.mockService));
    assertTrue(AopUtils.isCglibProxy(this.mockService));
    assertEquals(AopProxyUtils.ultimateTargetClass(this.mockService), MockService.class);
    assertEquals(AopTestUtils.getTargetObject(this.mockService).getClass(), MockService.class);
    assertEquals(
        AopTestUtils.getUltimateTargetObject(this.mockService).getClass(), MockService.class);
  }
