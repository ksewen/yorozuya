...
class BasicEnvironmentTest {
    ...
    void getEnvironment() {
        String env = "test";
        assertThat(this.environment.getEnvironment()).isEqualTo(SystemConstants.PROPERTIES_NOT_SET_VALUE);
    ...
    void getApplicationName() {
        String app = "yorozuya";
        assertThat(this.environment.getApplicationName()).isEqualTo(SystemConstants.PROPERTIES_NOT_SET_VALUE);
